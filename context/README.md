...
## 🧠 Context Index
1. [Project Architecture & Logic](./development-context.md) - Technical details of modules and workflows.
2. [CLI Schema](./cli-commands.md) - Definition of CLI commands and parameters.
